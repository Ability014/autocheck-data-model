        ...
        create or replace transient table AUTOCHECK.INTERMEDIATE.int_borrower_repayments
         as
    ...
    FROM AUTOCHECK.STAGING.stg_loan_schedule
),
indexed_repayments as (
    ...
    FROM AUTOCHECK.STAGING.stg_loan_repayments
)
SELECT
    s.*,
    payment_id,
